...
def display_citations_moyennes():
    ...
    if st.session_state.finish == False :
        ...
        st.text_area("", current_question["phrase"], disabled=True, key="citations_moyen")
        ...
        if st.session_state.show_feedback:
            st.text_area("Feedback", st.session_state.feedback, disabled=True, key="reponses_citations_moyen")
